...
async function populateSchedule() {
	...
	*/
	...
	about.innerHTML = '<div class="aboutImg"><img alt="Music Festival Schedule Logo" src="./favicon.png" /></div><h3>Questions & e-transfer donations:</h3><p><a href="mailto:yamyam@yamyam.ca" class="contact">yamyam@yamyam.ca</a></p><p>Not affiliated with any organization. This is not an official app and no assurances are made about the accuracy of the content.</p><p>Official website FAQ: <a class="aboutLink" target="_blank" href="https://edmontonfolkfest.org/faq/">https://edmontonfolkfest.org/faq/</a></p><p>No data is collected or transmitted by this app (which is why your settings don&rsquo;t transfer between devices). You can manually transfer your schedule using the buttons below.</p>';
